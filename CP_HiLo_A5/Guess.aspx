<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Guess.aspx.cs" Inherits="CP_HiLo_A5.Guess" %>
      ...
      <b>  <asp:Label ID="buttonPrompt" runat="server" Font-Names="Tahoma" 
       ...
       &nbsp;
        ...
        <asp:Button ID="magicButton" runat="server" Text="Enter" 
            onclick="guess_Click" BackColor="#F8F1F0" Font-Bold="True" 
            ForeColor="Blue" />
        &nbsp;&nbsp;&nbsp;
       ...
       <b> <asp:RangeValidator ID="ioBoxValidator2" runat="server" 
            BackColor="#FFFF99" BorderStyle="Outset" ControlToValidate="ioBox" 
            ErrorMessage="Please enter an integer "  MaximumValue="2147483647"  MinimumValue="1" Type="Integer" Font-Names="Calibri" Height="16px" Width="787px" ForeColor="Red">
            </asp:RangeValidator></b>   
        <br />

       <asp:Label id="Message"  runat="server"
           BackColor="#FFFF99" BorderStyle="Outset" ControlToValidate="ioBox" 
             Font-Names="Calibri" Height="16px" Width="787px" ForeColor="Red"
           AssociatedControlID="ioBox"/>
